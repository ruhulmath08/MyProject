...
public class Product  implements java.io.Serializable {
    ...
    public Product(SubCategory subCategory, String proName, int proQty, double proPrice, String proUri, String proDesc) {
    ...
    public Product(SubCategory subCategory, String proName, int proQty, double proPrice, String proUri, String proDesc, Set proOrderDetailses) {
       this.subCategory = subCategory;
       this.proName = proName;
       this.proQty = proQty;
       this.proPrice = proPrice;
